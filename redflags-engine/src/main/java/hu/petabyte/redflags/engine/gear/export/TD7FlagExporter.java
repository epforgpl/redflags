 ...
 */
@Component("H2FlagExporter")
@Scope("prototype")
public class TD7FlagExporter extends FlagExporter {

	@Override
	protected String filename() {
		return super.filename().replace(".", "-H2.");
	}

	@Override
	protected boolean shouldInclude(AbstractIndicator i) {
		return i instanceof AbstractTD7Indicator;
	}

	@Override
	protected boolean shouldInclude(Notice notice) {
		Type td = notice.getData().getDocumentType();
		return (null != td && td.getId().equals("TD-7"));
	}
